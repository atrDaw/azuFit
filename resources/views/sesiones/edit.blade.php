...
@section('title', 'Editar Sesión - Azufit')
            ...
            <div class="card border-0 shadow-sm rounded-3 bg-white">
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="text-center mb-4">
                        <h1 class="h3 fw-bold mb-1">Editar Sesión</h1>
                        <p class="small text-muted-color mb-0">Modifica los detalles del directo programado.</p>
                    </div>
                    ...
                    <form class="needs-validation" novalidate action="{{ route('sesiones.update', $sesion->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="invalid-feedback">Introduce un título.</div>
                        ...
                        {{-- Preparamos fecha y hora por separado --}}
                        @php
                        ...
                        {{-- URL de la Reunión --}}
                        <div class="mb-4">
                            <label for="url_sesion" class="form-label small fw-bold text-muted-color">Enlace de la Reunión</label>
...
{{-- Reutilizamos el script de validación --}}
<script>
    (function() {
        'use strict';
