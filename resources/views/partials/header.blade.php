      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
          <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-4 gap-md-2 text-center">
            <li class="nav-item ">
              <a class="nav-link fw-medium hover:text-primary-color" href="#">Clases Online</a>
            </li>
            <li class="nav-item">
              <a class="nav-link fw-medium hover:text-primary-color" href="#">Clases Privadas</a>
            </li>
            <li class="nav-item">
              <a class="nav-link fw-medium hover:text-primary-color" href="#">Sobre Nosotros</a>
            </li>
            <li class="nav-item">
              <a class="nav-link fw-medium hover:text-primary-color" href="#">Testimonios</a>
            </li>
          </ul>
